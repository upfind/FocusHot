...
package cn.upfinder.uilibrary.Adapter;
...
import cn.upfinder.uilibrary.Animation.AlphaInAnimation;
import cn.upfinder.uilibrary.Animation.BaseAnimation;
import cn.upfinder.uilibrary.Animation.CustomAnimation;
import cn.upfinder.uilibrary.Animation.ScaleInAnimation;
import cn.upfinder.uilibrary.Animation.SlideInBottomAnimation;
import cn.upfinder.uilibrary.Animation.SlideInLeftAnimation;
import cn.upfinder.uilibrary.Animation.SlideInRightAnimation;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private BaseViewHolder getLoadingView(ViewGroup parent) {
        if (mLoadingView == null) {
            return createBaseViewHolder(parent, R.layout.default_loading);
        }
